...
var arr = [{
  ...
  story: "https://img.freepik.com/premium-photo/portrait-handsome-young-black-man-outdoors-city_251136-88951.jpg?w=740"
}, {
  db: "https://img.freepik.com/premium-photo/studio-portrait-handsome-man-against-gray-background_251136-89286.jpg?w=740",
  story: "https://img.freepik.com/premium-photo/full-length-studio-portrait-handsome-man-standing-against-gray-background_251136-89274.jpg?w=740"
}];
var clutter = "";
arr.forEach(function (elem, idx) {
  clutter += "\n <div class=\"story\">\n          <img id=\"".concat(idx, "\" src=\"").concat(elem.db, "\" alt=\"\" />\n        </div>\n        \n        ");
});
